    ...
    <>
      {context.windowWidth < 992 && (
        <Button
          ...
          onClick={() => addToCart(currentProduct)} style={{ backgroundColor: 'black', color: 'white' }}
        >
      ...
      <section className="detailsPage mb-5" style={{ marginTop:"-6.5rem" }}>
        {context.windowWidth > 992 && (
        ...
        <div className="container detailsContainer pt-3 pb-3">
          <div className="row">
            ...
            <div className="col-md-7 productInfo">
              <h1 style={{ color: 'black' }}>{currentProduct.productName}</h1>
              ...
              <div className="priceSec d-flex align-items-center mb-3">
                <span className="text-g priceLarge" style={{  color: 'black' }}>
              ...
              {currentProduct.SIZE !== undefined &&
                currentProduct.SIZE.length !== 0 && (
                  <div className="productSize d-flex align-items-center">
                    <span>SIZE:</span>
                    <ul className="list list-inline mb-0 pl-4" style={{ backgroundColor: 'black', color: 'white' }}>
              ...
              <div className="d-flex align-items-center">
                <div className="d-flex align-items-center">
                  {context.windowWidth > 992 && (
                    <Button
                      className={`btn btn-lg addtocartbtn ${
