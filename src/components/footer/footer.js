              ...
              {fluid.map((item, index) => (
                <div key={index} className="col">
                  <div className="box d-flex align-items-center w-100">
                    ...
                    <div className="info">
                      <h4 style={{ color: 'black' }}>{item.header}</h4>
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-md-3 part1">
                ...
                <br />
                <br />
                <h4>Awesome Multi Purpose store website </h4>
                <br />
                ...
                <h6
                  className="mail-tel"
                  onClick={() => (window.location = 'abhinavsai689@gmail.com.com')}
                >
                  <EmailOutlinedIcon /> <strong>✉ Email : </strong> abhinavsai689@gmail.com
                </h6>
                <h6>
