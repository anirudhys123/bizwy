              ...
              <nav>
                <ul className="list list-inline">
                  <li className="list-inline-item position-static">
                    <Button className="catTab res-hide" style={{ backgroundColor: 'black', color: 'white' }}>
                      <GridViewIcon /> &nbsp;
                    ...
                    >
                      ...
                      <div className="showM">
                        {!expanded ? (
                          <Link onClick={handleShowMore} style={{ backgroundColor: 'black', color: 'white' }}>Show More</Link>
                        ) : (
                          <Link onClick={handleShowLess} style={{ backgroundColor: 'black', color: 'white' }}>Show Less</Link>
                        )}
                      </div>
                    </div>
                  </li>
            ...
            <div className="col-sm-2 part3 d-flex align-items-center">
              <div className="phNo d-flex align-items-center ml-auto">
                ...
                <div className="info ml-3">
                  <h3 className="text mb-2" style={{color: 'black' ,fontSize:"0.5rem" }}>8374772478</h3>
